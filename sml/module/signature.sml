...
(* user can only use Whole or make_frac to create RATIONAL*)
...
(* val rational = MyRational.Frac(1.1, 1) *) (* does not type-check *)
val rational = MyRational.make_frac(1.1, 1)

(* MyRational.gcd (3, 4) *) (* does not type-check *)
